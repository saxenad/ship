...
import BitmapHandling.CameraUtil;
import BitmapHandling.PhotoHandler;
...
*/
   ...
   public void onClick(View v) {
    ...
    private void takePicture(){
     ...
     _camera.takePicture(_shutterCallback, null, new PhotoHandler(getApplicationContext()));
 ...
 private void MoveToShippingActivity(File photoFile){
